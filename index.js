...
const pepperoni = createMenuItem("pepperoni pizza", 10, "lunch");

console.log(pepperoni);

const waffles = createMenuItem("waffles", 5, "breakfast");

console.log(waffles);

const bbq = createMenuItem("bbq ribs", 20, "dinner");
...
const review = {
  name: "Josh",
  rating: 5,
  feedback: "excellent place! nothing to say."
}
...
function getLastReview(array) {
  ...
  let lastIndexOf = array.length - 1;
  let name = array[lastIndexOf].name;
  let rating = array[lastIndexOf].rating;
  let feedback = array[lastIndexOf].feedback;
